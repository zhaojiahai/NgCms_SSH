...
KE.util = {
	...
	getFullHtml : function(id) {
		...
		html +='<link href="'+sys_ctx+'/css/reset.css" rel="stylesheet" type="text/css" />';
        html +='<link href="'+sys_ctx+'/css/base.css" rel="stylesheet" type="text/css" />';
...
KE.dialog = function(arg){
	...
	this.show = function() {
		...
		if (arg.html !== undefined) {
			...
			if (arg.cmd=="image"){
				if ((typeof(sys_ke_remoteUrl)=='undefined')||(sys_ke_remoteUrl=="")){
					iframe.src = KE.g[id].pluginsPath +'image/'+ arg.cmd + '.html';
				}else{
					iframe.src=sys_ke_remoteUrl+"?returnUrl="+sys_ke_returnUrl+"&id="+id;
				}
        	}else{
