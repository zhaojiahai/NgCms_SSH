...
<div class="place">
    <span>位置：</span>
    <ul class="placeul">
        <li><a href="clCreditApply.html">合同信息护</a></li>
        <li><a href="clCreditApplyAdd.html">添加</a></li>
    </ul>
</div>
    ...
    <div class="formbody">
        ...
        <ul class="forminfo">
            ...
            <li><label>业务品种</label>
                ...
                <cite></li>
            <li><label>流水号</label><input name="" type="text" class="dfinput" value=""/> </li>
            <li><label>合同编号</label><input name="" type="text" class="dfinput" value=""/> </li>
            <li><label>金额</label><input name="" type="text" class="dfinput" value=""/> </li>
            ...
            <li><label>合同起始日期</label><input name="" type="text" class="dfinput" value=""/></li>
            <li><label>合同到期日期</label><input name="" type="text" class="dfinput" value=""/></li>
            <li><label>期限(月)</label><input name="" type="text" class="dfinput" value=""/></li>
            ...
            <li><label>	基准利率(‰)</label<input name="" type="text" class="dfinput"  value=""/></li>
            ...
            <li><label>合同份数</label><input name="" type="text" class="dfinput"  value=""/></li>
