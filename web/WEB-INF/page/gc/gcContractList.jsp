...
<form action="" method="post">
    <div class="rightinfo">
        <div class="tools">
            <ul class="toolbar1">
                <li><a href="/contractAction_contractAddHtml.action"><span><img src="/images/t01.png" /></span>新增合同</a></li>
            </ul>
        </div>
        <table class="tablelist">
            <thead>
            <tr class="tablehead"><td colspan="8">合同列表</td></tr>
            </thead>
            <thead>
            <tr>
