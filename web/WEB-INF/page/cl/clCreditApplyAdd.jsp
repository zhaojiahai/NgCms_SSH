...
<form action="" method="post">
    <div class="formbody">
        ...
        <ul class="forminfo">
            <li><label>客户编号</label><input name="" type="text" class="dfinput" value=""/>
            </li>
            ...
            <li><label>借款用途</label><input name="" type="text" class="dfinput"  value=""/></li>
            ...
            <li><label>主办客户经理 </label><input name="" type="text" class="dfinput"  value=""/></li>
            <li><label>所属机构</label><input name="" type="text" class="dfinput"  value=""/></li>
